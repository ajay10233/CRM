...
export default function GenerateCouponManager() {
  ...
  const handleSubmit = async () => {
    if (!name || discountPercentage <= 0 || durationInDays <= 0) {
    ...
    try {
      const url =
        formMode === "create" ? "/api/coupons" : `/api/coupons/${editingId}`; // remove `/edit`
              ...
              return (
                ...
                >
                  <div className="space-y-1 text-sm">
                    ...
                    <p>
                      <strong>Starts:</strong> {start.toLocaleDateString()}
                    </p>
                    <p>
                      <strong>Expires:</strong> {end.toLocaleDateString()}
                    </p>
                    <p>
